...
void fae::SetupWindow(entt::registry& registry)
{
	...
	glfwWindowHint(GLFW_CONTEXT_VERSION_MAJOR, static_cast<GLint>(descriptor.glfwVersionMajor));
	glfwWindowHint(GLFW_CONTEXT_VERSION_MINOR, static_cast<GLint>(descriptor.glfwVersionMinor));
